    ...
    <OverlayContainer>
      ...
      >
        <div
          ...
          ref={ref}
          className={clsx(
            "bg-default-200 rounded-lg w-full focus-visible:ring-offset-0 focus-visible:outline-none relative",
            {
              "max-w-lg": size === "sm",
              "max-w-2xl": size === "md",
              "max-w-5xl": size === "lg",
        ...
        >
          ...
          <button
            className="absolute top-4 right-4 hidden group-data-[has-x=true]:block"
            onClick={onClose}
          >
            <XMark size={20} />
          </button>
