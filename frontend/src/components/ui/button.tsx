...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        `z-0 group relative inline-flex items-center justify-center box-border appearance-none select-none whitespace-nowrap font-normal
                overflow-hidden outline-none transition-transform-colors-opacity motion-reduce:transition-none`,
        buttonConfig[size],
