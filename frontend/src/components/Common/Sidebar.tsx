    ...
    <div className="w-full">
      ...
      >
        <div className="flex items-center gap-2">
          {item.icon && (
            <div className="text-inherit group-hover:text-inherit transition-colors duration-200">
              {item.icon}
            </div>
          )}
          <span
        ...
        <div
          className={cn(
            "text-sm font-medium transform transition-transform duration-200",
            {
              hidden: isCollapsed,
              "rotate-90": isOpen,
            },
      ...
      className={cn(
        ...
        `${
          item.disabled
            ...
            : "cursor-pointer text-default-500 hover:text-default-600"
        }`,
        {
          "pl-4": level === 0,
          "hover:bg-content2 bg-content1 pl-8": level === 1,
    ...
    >
      ...
      >
        <div className="p-4 flex items-center justify-between mb-4">
          <h1
            className={cn(
              "font-semibold text-3xl transition-opacity duration-200 opacity-100",
              {
        ...
        <div className="flex flex-col flex-1 overflow-y-auto">
          ...
          <div className="">
            {currentUser?.email && (
              <p className="text-secondary text-sm p-2 max-w-44">
