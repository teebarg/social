...
export type TDataSocialAccessToken = {
    formData: Body_login_social;
};
...
export class LoginService {
     ...
     * @throws ApiError
     */
    public static socialAccessToken(data: TDataSocialAccessToken): CancelablePromise<Token> {
        const { formData } = data;
        return __request(OpenAPI, {
            method: "POST",
            url: "/api/v1/login/social",
            body: formData,
...
export class DraftService {
     ...
     * @throws ApiError
     */
    public static getAll(data: TDataReadDrafts = {}): CancelablePromise<DraftsPublic> {
        const { limit = 100, skip = 0 } = data;
        return __request(OpenAPI, {
            method: "GET",
            url: "/api/v1/drafts/",
     ...
     * @throws ApiError
     */
    public static create(data: TDataCreateDraft): CancelablePromise<DraftPublic> {
        const { requestBody } = data;
        return __request(OpenAPI, {
            method: "POST",
            url: "/api/v1/drafts/",
     ...
     * @throws ApiError
     */
    public static delete(data: TDataDeleteDraft): CancelablePromise<Message> {
        const { id } = data;
        return __request(OpenAPI, {
            method: "DELETE",
